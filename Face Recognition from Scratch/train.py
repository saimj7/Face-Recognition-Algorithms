...
from mylib.face_recognition import FaceRecognizer
...
ap.add_argument("-s", "--data", required=True, help="path to the gathered data directory")
...
for (i, path) in enumerate(glob.glob(args["data"] + "/*.txt")):
